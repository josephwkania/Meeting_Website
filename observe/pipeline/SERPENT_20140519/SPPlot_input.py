...
# the number of baselines you have chosen.
...
AIPS.userno = 4004            	# The AIPS user number the data is on.
Name = '2007+404'             	# The uvdata name of the catalogue.
Klass = 'UVFIX'                 # The uvdata klass of the catalogue.
...
specifysources = ['2033+4113']	      # Must be strings in python list format.


choosebaselines = 'all'	              # Please select either 'all' or 'choose'
	
specifybaselines = [[2,8]]	      # Specify your baselines in a tuple format, i.e. [[1,2],[1,5],etc]
...
outfilename = '2033+4113'      	      # This is the base name of your output plots.
...
timeperpage = 1057 		      # Set the amount of visibilities to use per page - i.e. the amount of time 
                                      # (y-axis) to squeeze onto a sheet of A4. Something between 1000-2000 is fine.

IF = 8				      # How many IFs are present in your dataset i.e. for e-Merlin L-Band = 8, 
                                      # C-Band = 16.

IF_start = 3 			      # Choose starting IF to plot.
